...
templates_helvetica = load_templates("templates_personal")    # huruf + angka untuk lainnya


# # ==== 8. Eksekusi dengan template matching semua ====

# print("🔍 Hasil Ekstraksi:")
# for field, roi in rois.items():
#     if field == "NIK":
#         templates = templates_ocra
#     else:
#         templates = templates_helvetica

#          # Save ROI for debug
#     cv2.imwrite(f"debug_roi_{field}.png", roi)
#     result = recognize_text(roi, templates)
#     print(f"{field:<15}: {result}")

# ==== 9. Eksekusi dengan tesseract ====
print("🔍 Hasil Ekstraksi:")
results = {}
for field, roi in rois.items():
    if field == "NIK":
        ...
        result = tesseract_ocr(roi)  # Use Tesseract OCR
